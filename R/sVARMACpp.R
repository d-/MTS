...
#'
#' Performs conditional maximum likelihood estimation of a seasonal VARMA
#' model.  This is the same function as sVARMA, with the likelihood function
#' implemented in C++ for efficiency.
#'
#' Estimation of a seasonal VARMA model
#'
#' @usage sVARMACpp(da, order, sorder, s, include.mean = T, fixed = NULL,
#' details = F, switch = F)
...
"sVARMACpp" <- function(da, order, sorder, s, include.mean = T, fixed = NULL, details = F, switch = F) {
  ...
  if (details) {
    fit <- nlminb(
      start = par, objective = LLKsVARMACpp, zt = DX, Order = Order, ARlags = ARlags, MAlags = MAlags, include.mean = include.mean,
